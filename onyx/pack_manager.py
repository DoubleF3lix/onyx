...
class DataPack(Stringable):
    ...
    def generate(
        ...
        return_values = {"output_path": pack_output_path, "generation_time": time.time() - self.gen_time_start}
        ...
        if print_generation_time:
            print(f"Pack generated in {round(return_values['generation_time'], 6)} seconds")
