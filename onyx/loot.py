...
from .enums import loot_type, AbsPos, RelPos, LocPos, CurrentPos, item, container_type, container_slot
...
def give(targets: selector, loot_type: loot_type, loot_table: str = None, killed_entity: selector = None, mined_block: Union[AbsPos, RelPos, LocPos, CurrentPos] = None, item_used: Union[item, str] = None):
